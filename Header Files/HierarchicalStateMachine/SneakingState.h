...
#ifndef A_TURTLE_IN_THE_ZOO_SNEAKINGSTATE_H
#define A_TURTLE_IN_THE_ZOO_SNEAKINGSTATE_H
#include "MovementState.h"

class SneakingState : public MovementState {
public:
...
#endif //A_TURTLE_IN_THE_ZOO_SNEAKINGSTATE_H